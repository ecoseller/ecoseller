...
const Training = ({
  ...
  return (
    <Stack spacing={2}>
      ...
      <Typography variant="body1">
        {t("Peak memory percentage")} : {statistics.peakMemoryPercentage.toFixed(2)} %
      </Typography>
      <Typography variant="body1">
        {
      ...
      <Typography variant="body1" style={{whiteSpace: "pre-line"}}>
        {t("Metrics")} :<br/>
        <code>
          {JSON.stringify(statistics.metrics, null, 4)}
        </code>
      </Typography>
      <Typography variant="body1" style={{whiteSpace: "pre-line"}}>
        {t("Hyperparameters used")} :<br/>
        <code>
          {JSON.stringify(statistics.hyperparameters, null, 4)}
        </code>
      </Typography>
    </Stack>
  );
