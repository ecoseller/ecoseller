...
interface IRecommenderAnalyzerProps {
  users: any[];
}

const DashboardRecommenderSystemAnalyzerPage = ({
  users,
}: IRecommenderAnalyzerProps) => {
  return (
    <DashboardLayout>
...
DashboardRecommenderSystemAnalyzerPage.getLayout = (page: ReactElement) => {
  return (
    <RootLayout>
...
export default DashboardRecommenderSystemAnalyzerPage;
